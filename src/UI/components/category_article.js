    ...
    elements.forEach(element => {
        ...
        element.outerHTML = `
            <article class="rounded-md border-4 border-blue-300 text-white w-52 h-1/2 overflow-hidden cursor-pointer bg-slate-700 group relative">
                <a href="/pages/nose" class="bg-black bg-opacity-60 absolute top-0 left-0 w-full h-full opacity-0 group-hover:opacity-100 transition-opacity duration-[30ms] text-4xl font-zelda flex items-center justify-center">${title}</a>
