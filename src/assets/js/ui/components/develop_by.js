export default function develop_by() {
    document.querySelector("#develop-by").outerHTML = `
        <div class="w-fit flex flex-col items-center gap-2 justify-end">
            ...
            <a href="https://github.com/nox456" target="_blank" class="flex items-center  border-t border-r border-green-300 transition-colors gap-2 hover:bg-green-300 hover:bg-opacity-30 p-2 text-white w-full rounded-tr-md justify-center">
